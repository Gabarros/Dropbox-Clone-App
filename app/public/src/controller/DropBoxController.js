class DropBoxController {
    ...
    connectFirebase() {
        ...
        var firebaseConfig = {
            apiKey: "AIzaSyAT29wa_kD0dPBbaL-7pa-5kEA_R2imt0c",
            authDomain: "dropbox-clone-2402d.firebaseapp.com",
            databaseURL: "https://dropbox-clone-2402d.firebaseio.com",
            projectId: "dropbox-clone-2402d",
            storageBucket: "",
            messagingSenderId: "979552426028",
            appId: "1:979552426028:web:db4610fcd00180c593d989",
            measurementId: "G-2N73NVZX4G"
        };
        // Initialize Firebase
    ...
    initEvents() {
        ...
        this.inputFilesEl.addEventListener('change', event => {
            ...
            this.modalShow(true, this.snackModalEl);
    ...
    uploadComplete() {
        ...
        this.modalShow(false, this.snackModalEl);
